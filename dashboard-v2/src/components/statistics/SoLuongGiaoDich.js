...
class SoLuongGiaoDich extends Component {
    constructor(props) {
        super(props);
        this.state = {
            chartData: {
    ...
    render() {
        ...
        return (
            <div className="chart item">
                ...
                <div className="col-xs-6 col-sm-6 col-md-6 col-lg-6 up">
                    <p className="chargreen"><span className="glyphicon glyphicon-triangle-top"></span> 5%</p>
                </div>
            </div>
        )
    }
...
export default SoLuongGiaoDich;
